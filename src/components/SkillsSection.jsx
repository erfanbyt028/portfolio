...
const skills = [
  ...
  { name: "ٍRedux", level: 85, category: "frontend" },
  { name: "ٍRedux Toolkit", level: 80, category: "frontend" },
  { name: "ٍReact Router", level: 90, category: "frontend" },
  { name: "ٍRect Hook Form + YUP & ZOD", level: 90, category: "frontend" },
  ...
  { name: "ٍLinux", level: 70, category: "tools" },
];
